...
get_min_allowed_time_spent_on_page <- function(page_number) {
  ...
  else if (page_number == "276892") {retval = 8 } #info about WFH 1 
  else if (page_number == "276894") {retval = 6 } #info about WFH 2
  else if (page_number == "276940") {retval = 9 } #HO decision maker & location normativness
  #else if (page_number == "280452") {retval = 2 } #intro justice - do we want to take this into account?
  else if (page_number == "276897") {retval = 10 } #JOD1
  else if (page_number == "276808") {retval = 7 } #JOD2
  else if (page_number == "276915") {retval = 12 } #JOP1
  else if (page_number == "277059") {retval = 8 } #JOif
  ...
  else if (page_number == "276943") {retval = 10 } #ergonomics
  ...
  else if (page_number == "276896") {retval = 8 } #overall justice
